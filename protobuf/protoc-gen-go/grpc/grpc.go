...
// Given a type name defined in a .protocol, return its object.
...
// Given a type name defined in a .protocol, return its name as we will print it.
...
// Generate generates code for the m_services in the given file.
