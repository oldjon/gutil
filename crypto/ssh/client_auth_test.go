...
func TestClientUnsupportedCipher(t *testing.T) {
	...
	if err := tryAuth(t, config); err == nil {
		t.Errorf("expected no ciphers in util")
	}
}
...
func TestClientUnsupportedKex(t *testing.T) {
	...
	if err := tryAuth(t, config); err == nil || !strings.Contains(err.Error(), "util algorithm") {
		t.Errorf("got %v, expected 'util algorithm'", err)
	}
}
